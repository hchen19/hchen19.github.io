...
- **[Deep Additive Kernel Learning](/publication/4-conference-dak/)** equips the last-layer GP in <a href="https://proceedings.mlr.press/v51/wilson16.pdf" style="color:blue;">deep kernel learning</a> with an additive structure and induced prior approximations, yielding an equivalent last-layer <a href="https://arxiv.org/pdf/2007.06823" style="color:blue;">Bayesian neural network</a> architecture that preserves interpretability while lowering the computational complexity.